 ...
 *   2.11.3 - 2.11.6: Warn when local and private vals, vars, defs, and types are are unused.
 *   2.11.7 - 2.12.0: Warn when local and private vals, vars, defs, and types are unused.
 */
